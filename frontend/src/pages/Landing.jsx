  ...
  return (
    <div className="relative min-h-screen bg-[#0a0d0a] text-ink-100 font-body overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 h-16 flex items-center justify-between gap-4">
          <Link to="/" className="flex items-center gap-3 shrink-0 group">
            <div className="h-9 w-9 rounded-lg overflow-hidden bg-white/95 ring-2 ring-gold-500/30 group-hover:ring-gold-500/60 transition p-1">
              <img src="/logo.webp" className="h-full w-full object-contain" alt="BidArenaX" />
            </div>
            <span className="font-editorial text-2xl font-bold tracking-wide text-green-400">
      ...
      <section className="relative min-h-[92vh] flex items-end overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-8 pt-32 pb-16 md:pb-24 w-full">
          ...
          <div className="flex flex-wrap items-center gap-4 mb-8">
            ...
            <Link to="/player-registration"
              className="inline-flex items-center gap-2 px-6 py-3.5 border border-green-600 text-white hover:bg-green-600 font-semibold text-sm rounded-lg transition hover:-translate-y-0.5">
              Player Registration
            </Link>
            {t && (
              <Link to={`/watch/${t._id}`}
      ...
      <section className="relative overflow-hidden" style={{ transform: "translateZ(0)" }}>
        ...
        <div className="fixed top-0 left-0 w-screen h-screen bg-black/78 -z-10" />
        
        <div className="relative max-w-7xl mx-auto px-4 sm:px-8 py-24 sm:py-32">
        ...
        <div className="grid md:grid-cols-2 gap-5">
          ...
          {(() => {
            const links = ["/player-registration", t ? `/watch/${t._id}` : "/player-registration"];
            return (
              <>
                <img
              src="ball.png"
              ...
              <div key={tt._id} className="rounded-2xl border border-white/[0.08] bg-white/[0.02] p-5 hover:border-gold-500/30 transition">
                <div className="flex items-center gap-3 mb-4">
                  <div className="h-11 w-11 rounded-xl bg-white/[0.06] border border-white/[0.08] overflow-hidden flex items-center justify-center shrink-0">
                    {tt.logo ? <img src={cldOptimize(tt.logo, 96)} className="h-full w-full object-cover" alt={tt.name} loading="lazy" /> : <i className="fa-solid fa-trophy text-gold-400" />}
                  </div>
                  ...
                  <Link key={tm._id} to={`/team/${tm._id}`}
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      <div className="h-11 w-11 rounded-xl bg-gold-500/10 overflow-hidden flex items-center justify-center shrink-0 border border-gold-500/20 group-hover:border-gold-500/40 transition">
                        {tm.logo
                          ? <img src={cldOptimize(tm.logo, 88)} className="h-full w-full object-cover" alt={tm.name} loading="lazy" />
      ...
      <footer className="border-t border-white/[0.06] bg-[#0a0d0a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 py-10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <img src="/logo.png" className="h-6 w-6 object-contain" alt="BidArenaX" />
             <span className="font-editorial text-xl font-bold tracking-wide text-green-400">
              BidArena<span className="text-white">X</span>
            </span>
            <span className="text-xs text-ink-500">©{new Date().getFullYear()} All rights reserved here.</span>
          </div>
