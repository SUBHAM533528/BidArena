    ...
    <div className="relative min-h-screen bg-[#0a0d0a] text-ink-100 font-body overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 h-16 flex items-center justify-between gap-4">
          <Link to="/" className="flex items-center gap-3 shrink-0 group">
            ...
            <span className="font-editorial text-2xl font-bold tracking-wide text-gold-400">
              Bid
              <span className="font-editorial text-ink-400 text-2xl">
                Arena
              </span>
            </span>
          </Link>
      ...
      <section className="relative min-h-[92vh] flex items-end overflow-hidden">
        ...
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.pexels.com/photos/29949985/pexels-photo-29949985.jpeg?cs=srgb&dl=pexels-imddicted-29949985.jpg&fm=jpg')",
          }}
        />
        <div className="absolute inset-0 bg-gradient-to-b from-black/70 via-black/45 to-[#0a0d0a]" />
        <div className="absolute inset-0 bg-gradient-to-r from-black/40 via-transparent to-transparent" />

        <div className="relative max-w-7xl mx-auto px-4 sm:px-8 pt-32 pb-16 md:pb-24 w-full">
          <h1 className="font-editorial text-4xl sm:text-5xl lg:text-6xl font-extrabold leading-[1.08] tracking-tight text-green-600 mb-5 max-w-3xl">
            {t ? (
              <>
                Build Your Dream XI at the
                <br className="hidden sm:block" /> {t.name}
              </>
            ) : (
              <>
                Build Your Dream XI at the
                <br className="hidden sm:block" /> Ultimate Cricket Auction
              </>
            )}
          </h1>
          ...
          <div className="flex flex-wrap items-center gap-4 mb-8">
            <Link
              to="/player-registration"
              className="inline-flex items-center gap-2 px-6 py-3.5 border border-white/40 text-white hover:bg-white/30 font-semibold text-sm rounded-lg transition hover:-translate-y-0.5"
            >
              Player Registration
            </Link>
            {t && (
              <Link
                to={`/watch/${t._id}`}
                className="inline-flex items-center gap-2 px-6 py-3.5 border border-flame-500/70 text-flame-400 hover:bg-flame-500/30 font-semibold text-sm rounded-lg transition hover:-translate-y-0.5"
              >
                <span className="w-1.5 h-1.5 rounded-full bg-flame-500 animate-pulse" />
                Watch Live
              </Link>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-8 py-20">
        <h2 className="font-editorial text-3xl sm:text-4xl font-bold text-white mb-10">
          How It Works
        </h2>
        <div className="grid md:grid-cols-2 gap-5">
          {(() => {
            ...
            return (
              <>
                <img
                  src="https://i.pinimg.com/736x/19/74/7a/19747af4c63e9bb7e4db5aa687372a63.jpg"
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-8 py-16">
        <div className="grid md:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="rounded-2xl overflow-hidden border border-white/[0.08] order-2 md:order-1">
            <img
              src="https://i.pinimg.com/1200x/c1/f4/9a/c1f49a6d519ac8f088d61ccbc611e250.jpg"
              alt="Team celebrating on the field"
              className="w-full h-full object-cover aspect-[4/3]"
            />
          </div>
      ...
      <footer className="border-t border-white/[0.06] bg-[#0a0d0a]">
        <div className="max-w-7xl mx-auto px-4 sm:px-8 py-10 flex flex-col sm:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-3">
            <span className="font-editorial text-xl font-bold text-gold-400">
              BidArena
            </span>
            <span className="text-sm text-ink-500">
              ©{new Date().getFullYear()} All rights reserved here.
            </span>
          </div>
